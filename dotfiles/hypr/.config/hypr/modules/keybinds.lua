...
local wallpaper   = os.getenv("HOME") .. "/.config/rofi/scripts/wallpapermenu.sh"
local powermenu   = os.getenv("HOME") .. "/.config/rofi/scripts/powermenu.sh"
